...
Amendment (2.1.0): added Principle X (ask one question at a time, using
  interactive prompts where available) and Principle XI (lead long
  summaries with a layman's TL;DR). Both are additive — no existing
  principle was changed or removed. Propagated to AGENTS.md (rules 10 and
  11) so they load into every turn's context, and to MANIFEST.md's counts.
-->
...
**Version**: 2.1.0 | **Ratified**: 2026-07-15 | **Last Amended**: 2026-07-26
