...
- **A guild emblem is composed from parts we author**, never uploaded: **one of 36 icons, an icon colour from a vivid palette of 12, and a background colour from a separate dark palette of 12** — **5,184 combinations**, every one legible because the two palettes never overlap. Guilds get real expression, nothing needs moderating, and no emblem can come out ugly.
