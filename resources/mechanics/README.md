...
| 02 | *`02-powers.md`* | Up to 5 powers per hero, cooldowns, targeting, costs | Not started |
| 03 | *`03-turns.md`* | Turn order, action economy, how Speed spends | Not started |
| 04 | *`04-status.md`* | Crowd control and buff/debuff effects; what Resolve resists | Not started |
| 05 | *`05-progression.md`* | Levels, rarity, shards, currency, the rating ladder | Not started |
| 06 | *`06-defense-ai.md`* | How the engine plays a defense squad | Not started |
...
- **Powers gate almost everything.** Status effects can't be specified until
  ...
  until then either. Cooldown pacing in `03-turns.md` has the same problem.
...
- The 9 damage types, their `counter` map, and the weakness-derivation rule —
  `../LORE-and-flavor.md`.
- 27 heroes, 3 per type; squads of exactly 5; the player commands offense while
  the engine runs every defense.
