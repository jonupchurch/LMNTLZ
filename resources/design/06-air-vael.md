# Vael — "The Falling Sky" — DALL·E Portrait Prompt (Air)
...
Character: Vael, A reckless storm-diver who leaps first and lets gravity do the paperwork; an aerial shock-attacker.
Build & silhouette: Athletic and coiled, drawn mid-plummet; a daredevil's dynamic frame.
Face & demeanor: A wild grin or gritted focus, storm-grey eyes, hair blown straight back by the descent; a scar or two.
Wardrobe: A wingsuit-like glider-cloak in dark cyan and silver, a buckled harness, aerodynamic wraps; goggles pushed up on the brow.
Held / signature: Uses momentum itself — diving strikes with a heavy dive-blade or gauntlets that hit like a thunderclap on landing.
Element cue (subtle, behind or around the figure only): A cone of rushing wind and static wraps them; lightning threads the trailing air; a sonic-boom ring blooms on impact.
Element color (rim light + background gradient): Air — core #8FCFE0, accent #DCE6EA.
```

*Full character brief: `../characters/06-air-vael.md`.*
