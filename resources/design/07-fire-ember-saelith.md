# Ember Saelith — "The First Spark" — DALL·E Portrait Prompt (Fire)
...
Character: Ember Saelith, A warm, laughing pyromancer who lights up a room — until the room stops being safe.
Build & silhouette: Youthful and vivacious, medium build, with an open and expressive posture.
Face & demeanor: A bright, dimpled smile, warm amber eyes, freckles like ember-sparks; hair like banked coals catching the light.
Wardrobe: Bright orange-and-gold layered garb with sashes and ribbons that flicker like flame-tongues; light and mobile, edges lightly singed.
Held / signature: Bare-handed flame — she cups fire in her palms and throws blooming bursts; perhaps a small lantern-censer.
Element cue (subtle, behind or around the figure only): Living flame dances at her fingertips, sparks trail her laughter, and her hair-tips glow.
Element color (rim light + background gradient): Fire — core #E8552B, accent #FFB347.
```

*Full character brief: `../characters/07-fire-ember-saelith.md`.*
