# Tidewarden Coll — DALL·E Portrait Prompt (Water)
...
Character: Tidewarden Coll, A stoic coastal bulwark who yields ground only to take a coastline; a defensive juggernaut.
Build & silhouette: Big and solid, barrel-chested — a breakwater given a body, with a planted stance.
Face & demeanor: Stern and salt-weathered, beard beaded with brine, steady blue eyes; calm resolve.
Wardrobe: Heavy blue-green scale-and-plate like a ship's hull, barnacled pauldrons, a warden's tabard; a kelp cloak.
Held / signature: A great tower shield shaped like a cresting wave and a boarding-maul; walls of water rise at his command.
Element cue (subtle, behind or around the figure only): Water sheets off his shield, a bulwark-wave curls up behind him, and foam gathers at his feet.
Element color (rim light + background gradient): Water — core #2A7FB8, accent #4FC3D6.
```

*Full character brief: `../characters/11-water-tidewarden-coll.md`.*
