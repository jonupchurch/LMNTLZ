# Cindara — "Daughter of the Long Burn" — DALL·E Portrait Prompt (Fire)
...
Character: Cindara, The coal, not the flame — a quiet, patient heat-witch whose fire is slow, deep, and inexorable.
Build & silhouette: Composed and upright, medium build; still and contained, radiating heat rather than throwing it.
Face & demeanor: A calm, smoldering gaze; dusky skin with a faint inner glow at the veins; dark hair with ember-red underlights.
Wardrobe: Deep smoke-red robes with banked-orange lining and little ornament; heat-shimmer at the hems; a single slow-glowing pendant.
Held / signature: A censer or brazier-staff of slow coals; she conjures creeping ground-heat and delayed detonations.
Element cue (subtle, behind or around the figure only): Heat-haze warps the air around her, embers pulse beneath her skin, and the ground glows faintly where she has stood.
Element color (rim light + background gradient): Fire — core #E8552B, accent #FFB347.
```

*Full character brief: `../characters/09-fire-cindara.md`.*
