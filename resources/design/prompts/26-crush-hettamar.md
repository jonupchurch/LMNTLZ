# Hettamar Ironfall — DALL·E Portrait Prompt (Crush)
...
Character: Hettamar Ironfall, A walking end-of-argument — a grim armored enforcer who settles things with one falling blow.
Build & silhouette: Massive, dense, and vertical — an iron column; planted and imposing.
Face & demeanor: Stoic and iron-jawed, shadowed under a heavy helm; unimpressed, immovable eyes.
Wardrobe: Full heavy bronze-iron plate, riveted and industrial, with a blunt executioner's aesthetic; anvil and rivet motifs.
Held / signature: A colossal war-maul or anvil-hammer raised to fall straight down — the final verdict.
Element cue (subtle, behind or around the figure only): A vertical bronze impact-shock and crater bloom on the downward blow, a shock-ring and debris-plume, ground buckling.
Element color (rim light + background gradient): Crush — core #B5732E, accent #E0A15A.
```

*Full character brief: `../characters/26-crush-hettamar.md`.*
