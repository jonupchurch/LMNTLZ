# Silka Pinquick — DALL·E Portrait Prompt (Pierce)
...
Character: Silka Pinquick, A tiny, blurring-fast skirmisher who's already behind you; a needle-quick trickster.
Build & silhouette: Small and wiry and coiled, kept low and quick; impish.
Face & demeanor: A sharp grin and glinting eyes, quick and cheeky; cropped hair and a smudge of grime.
Wardrobe: Close-fitting cobalt scout's gear festooned with slim throwing-spikes and needles; buckles and quick-draw bandoliers.
Held / signature: A cluster of needle-daggers and throwing pins — many small, precise punctures.
Element cue (subtle, behind or around the figure only): A scatter of thin cobalt puncture-lines from several angles at once, an after-image blur of speed, pinpoint sparks.
Element color (rim light + background gradient): Pierce — core #3B5BD1, accent #7B93F0.
```

*Full character brief: `../characters/23-pierce-silka.md`.*
