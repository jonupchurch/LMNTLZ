# Lucen — "The Unhidden" — DALL·E Portrait Prompt (Light)
...
Character: Lucen, A revealer who strips away illusions, wards, and secrets alike; light as pure exposure.
Build & silhouette: Lean and sharp, scholarly-agile, with an alert, probing posture.
Face & demeanor: Keen, searching eyes that glow faintly, a knowing half-smile; clean features and light-streaked hair.
Wardrobe: A sleek gold-and-white inquisitor's coat with lens and prism motifs; a monocle or ocular device; layered but light.
Held / signature: A prism-lantern or light-lens that projects revealing beams, and blades of focused light.
Element cue (subtle, behind or around the figure only): Beams that pierce and dispel, illusions peeling away in the glare, refracted rainbows, things made suddenly transparent.
Element color (rim light + background gradient): Light — core #F2C744, accent #FFF6D6.
```

*Full character brief: `../characters/14-light-lucen.md`.*
