# Kaellis — "The Duelist Immaculate" — DALL·E Portrait Prompt (Slash)
...
Character: Kaellis, A flawless swordsman who has never needed a second stroke; precision and pride made a person.
Build & silhouette: Trim, elegant, and upright — a perfect duelist's posture, not bulky.
Face & demeanor: Refined and composed with a faint superior calm; sharp, groomed features; perhaps a single clean scar.
Wardrobe: An immaculate crimson-and-steel duelist's coat, high collar, a single pauldron, a sash of rank; spotless and tailored.
Held / signature: One flawless longsword or saber, drawn with ceremony — a single clean cut.
Element cue (subtle, behind or around the figure only): A crimson after-image arc marks the perfect cut — a single bright slash-line across the frame, no wasted motion.
Element color (rim light + background gradient): Slash — core #C0313A, accent #F06A72.
```

*Full character brief: `../characters/19-slash-kaellis.md`.*
