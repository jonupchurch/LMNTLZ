# Umbriel — "The Undoing" — DALL·E Portrait Prompt (Dark)
...
Character: Umbriel, A reality-eroding void-mage who unwrites what should never have been; entropy incarnate.
Build & silhouette: Shifting and indistinct at the edges, tall, with parts of the silhouette seeming to be missing or dissolving.
Face & demeanor: Half-erased — features fading into void on one side; a single calm, vast violet eye; the rest of him unraveling.
Wardrobe: Tattered void-robes whose hems dissolve into nothing, star-flecked darkness within, magenta cracks of unmaking running through.
Held / signature: Zones of erasure — he reaches out and things simply cease; a hand trailing dissolving matter.
Element cue (subtle, behind or around the figure only): The world frays where he gestures — particle-dissolution, negative space eating the frame, magenta rifts opening.
Element color (rim light + background gradient): Dark — core #7A3FA0, accent #C64BB0.
```

*Full character brief: `../characters/17-dark-umbriel.md`.*
