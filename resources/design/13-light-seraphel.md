# Seraphel — "The Verdict" — DALL·E Portrait Prompt (Light)
...
Character: Seraphel, A judgmental paladin whose very gaze is an accusation; radiant law made flesh.
Build & silhouette: Tall and upright, armored and regal, utterly unwavering.
Face & demeanor: Stern beauty, luminous gold eyes, a cold righteous calm; hair like spun light; a faint halo.
Wardrobe: Radiant ivory-and-gold plate with judicial motifs — scales, verses, wing-etched pauldrons; a tabard cut like a court robe.
Held / signature: A blazing greatsword balanced like a set of scales; pillars of light descend as judgment.
Element cue (subtle, behind or around the figure only): A halo and descending light-beams; verdict-glyphs ignite around her; foes cast long, harsh shadows.
Element color (rim light + background gradient): Light — core #F2C744, accent #FFF6D6.
```

*Full character brief: `../characters/13-light-seraphel.md`.*
