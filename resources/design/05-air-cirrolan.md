# Cirrolan — "Whisper of the High Reach" — DALL·E Portrait Prompt (Air)
...
Character: Cirrolan, A sky-borne herald who carries rumors and storms in the same breath; a trickster messenger.
Build & silhouette: Slender and buoyant, seeming to hover; youthful and androgynous.
Face & demeanor: Mischievous, quick-grinning, wind-tousled; a scarf that never quite settles across the mouth.
Wardrobe: A courier's harness and layered wind-cloak of pale cyan, feathers and paper charms tucked in; a long streaming scarf and loose wraps.
Held / signature: No melee weapon — flings gusts and cyclone-borne messages; perhaps a signal-horn or bell that summons wind.
Element cue (subtle, behind or around the figure only): Swirls of cloud-vapor and drifting feathers; papers and leaves caught in updrafts; a soft silver storm-glow.
Element color (rim light + background gradient): Air — core #8FCFE0, accent #DCE6EA.
```

*Full character brief: `../characters/05-air-cirrolan.md`.*
