# Grieve — "The Wide Reaper" — DALL·E Portrait Prompt (Slash)
...
Character: Grieve, A grim reaper-swordsman who clears a room the way a scythe clears a field; sweeping and inevitable.
Build & silhouette: Tall and long-limbed, gaunt-powerful, with reach emphasized; looming.
Face & demeanor: Grim and hollow, shadowed beneath a hood; the tired eyes of a killer; scarred.
Wardrobe: A tattered crimson-black reaper's coat, long and heavy, with harvest and bone-stitch motifs; worn field-gear.
Held / signature: An oversized single-edged blade or war-scythe built for wide horizontal sweeps.
Element cue (subtle, behind or around the figure only): A single vast horizontal crimson sweep-arc cuts the full width of the frame — a mown swath left behind.
Element color (rim light + background gradient): Slash — core #C0313A, accent #F06A72.
```

*Full character brief: `../characters/21-slash-grieve.md`.*
