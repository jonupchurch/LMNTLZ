# Zephyrine — "The Thin Blade of Wind" — DALL·E Portrait Prompt (Air)
...
Character: Zephyrine, A wind-duelist who fights at a range no one can close, cutting with compressed air.
Build & silhouette: Lithe and tall with elongated limbs and a fencer's poise. Weightless-looking.
Face & demeanor: Sharp, fine features and a cool half-smile; pale eyes; hair streaming as if always in a private breeze.
Wardrobe: Layered silk and gauze in cyan and silver that trail like vapor; minimal armor, a high collar, long ribbons that read her every movement.
Held / signature: A slender rapier or a war-fan that shears the air — but her true weapon is the wind-blade the motion leaves behind.
Element cue (subtle, behind or around the figure only): Slivers of compressed wind trail her strokes; ribbons and hair are always in motion; faint whistling spiral-lines cut the air.
Element color (rim light + background gradient): Air — core #8FCFE0, accent #DCE6EA.
```

*Full character brief: `../characters/04-air-zephyrine.md`.*
