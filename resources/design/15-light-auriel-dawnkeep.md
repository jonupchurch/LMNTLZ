# Auriel Dawnkeep — DALL·E Portrait Prompt (Light)
...
Character: Auriel Dawnkeep, The last lantern on the wall — a steadfast guardian of light who simply will not go out.
Build & silhouette: Sturdy and warm, a sentinel's grounded stance with the shield forward.
Face & demeanor: Kind but resolute, with tired-around-the-eyes warmth and a gold-flecked gaze; weathered and hopeful.
Wardrobe: Warm ivory-gold watchman's armor, a lantern-motif tabard, a heavy cloak; everything well-worn and dependable.
Held / signature: A radiant lantern-shield and a beacon-mace; he casts protective domes of dawn-light.
Element cue (subtle, behind or around the figure only): A steady warm glow-dome shelters allies, a beacon-flare burns on the shield — the light of a held sunrise.
Element color (rim light + background gradient): Light — core #F2C744, accent #FFF6D6.
```

*Full character brief: `../characters/15-light-auriel-dawnkeep.md`.*
