# Mauless — "The Undenied" — DALL·E Portrait Prompt (Crush)
...
Character: Mauless, A relentless siege-breaker for whom guards break first and then everything under them; he refuses to be stopped.
Build & silhouette: Big and forward-leaning, a battering-ram build, hunched with unstoppable drive.
Face & demeanor: Set-jawed and teeth-bared with tunnel-vision determination; scarred and sweat-sheened, without a trace of fear.
Wardrobe: Battered bronze siege-armor with ram-and-breach motifs, a great shield-face like a battering head; chains and reinforcement plates.
Held / signature: A ram-shield and heavy gauntlet-fists, or a breaching maul — he shatters guards and walls alike.
Element cue (subtle, behind or around the figure only): Guards and shields shatter in a burst of bronze impact-shards, a breach-crack spidering outward through the dust of broken defense.
Element color (rim light + background gradient): Crush — core #B5732E, accent #E0A15A.
```

*Full character brief: `../characters/27-crush-mauless.md`.*
