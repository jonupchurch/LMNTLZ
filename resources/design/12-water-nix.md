# Nix — "of the Still Pool" — DALL·E Portrait Prompt (Water)
...
Character: Nix, Perfect, dangerous calm — an assassin-mage of motionless water; the last thing you see is the ripple.
Build & silhouette: Slight, silent, and poised, with a minimal, economical stance.
Face & demeanor: Blank serenity, glassy still eyes, wet-smooth pale skin; hair flat and dark like a mirror surface.
Wardrobe: Sleek, close-fitting deep-teal garb with mirror-still water motifs and a single reflective sash; understated.
Held / signature: Blades of frozen-still water or mirror-shards; strikes from perfect stillness with a single lethal ripple.
Element cue (subtle, behind or around the figure only): Mirror-flat water surfaces form around them and then shatter into shards; one expanding ripple marks a strike.
Element color (rim light + background gradient): Water — core #2A7FB8, accent #4FC3D6.
```

*Full character brief: `../characters/12-water-nix.md`.*
