# Lord Aiguille — "The Long Point" — DALL·E Portrait Prompt (Pierce)
...
Character: Lord Aiguille, A haughty rapier-noble who reaches you before you've decided to move; aristocratic range.
Build & silhouette: Tall and slender, imperiously straight, with long-limbed elegance.
Face & demeanor: Aloof and aquiline, a thin superior smile beneath lidded eyes; immaculate, with fine waxed features.
Wardrobe: Ornate cobalt-and-silver court-duelist's finery — long tails, lace at the cuffs, a single fine pauldron; pristine.
Held / signature: An extraordinarily long, fine estoc or rapier for outreaching every opponent.
Element cue (subtle, behind or around the figure only): A very long, thin cobalt thrust-line extends improbably far to a glinting pinpoint at extreme range.
Element color (rim light + background gradient): Pierce — core #3B5BD1, accent #7B93F0.
```

*Full character brief: `../characters/24-pierce-aiguille.md`.*
