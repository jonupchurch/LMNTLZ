# Corvane — "Shepherd of Endings" — DALL·E Portrait Prompt (Dark)
...
Character: Corvane, A somber psychopomp who knows the appointed hour of every soul on the field; death's quiet clerk.
Build & silhouette: Tall and lean and cloaked, with a shepherd's stoop and a staff in hand; patient.
Face & demeanor: Grave and ageless, a hooded shadow over pale features, knowing dark eyes; a raven on the shoulder.
Wardrobe: A long dark-violet shepherd's cloak marked with tally-strokes and hourglass motifs; a dim soul-lantern; a ragged hem.
Held / signature: A shepherd's crook that doubles as a scythe-staff, and a soul-lantern; he herds shadows and marks the doomed.
Element cue (subtle, behind or around the figure only): Dim violet soul-wisps gather to him, a lantern of pale ghost-light glows, ravens and drifting motes of the departed circle.
Element color (rim light + background gradient): Dark — core #7A3FA0, accent #C64BB0.
```

*Full character brief: `../characters/18-dark-corvane.md`.*
