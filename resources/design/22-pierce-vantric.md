# Vantric — "The Threading Spear" — DALL·E Portrait Prompt (Pierce)
...
Character: Vantric, A patient lancer who finds the one gap in a wall of shields; a needle threaded through armor.
Build & silhouette: Tall, straight, and disciplined — a spear-line of a man, fully controlled.
Face & demeanor: Focused and narrow-eyed, with an aimer's stillness; clean-cut, a single fixed stare.
Wardrobe: Trim cobalt-and-steel lancer's armor, streamlined, with a single long pennant; minimal and aerodynamic.
Held / signature: A long, fine spear built for one perfect thrust through a seam.
Element cue (subtle, behind or around the figure only): A single straight cobalt thrust-line drives forward to a bright pinpoint, all motion converging on one spot.
Element color (rim light + background gradient): Pierce — core #3B5BD1, accent #7B93F0.
```

*Full character brief: `../characters/22-pierce-vantric.md`.*
