# Reyna Two-Rivers — DALL·E Portrait Prompt (Slash)
...
Character: Reyna Two-Rivers, A dual-blade whirlwind who fights like a current — wide, fast, and everywhere at once.
Build & silhouette: Athletic and fluid, always drawn mid-motion, with a dynamic twin-weapon spread.
Face & demeanor: Fierce joy, wind-whipped hair, bright eyes, a warrior's grin; braids strung with river-beads.
Wardrobe: Layered crimson wraps and light leathers built for spinning motion, twin sheaths crossed at the back; sashes that stream like water.
Held / signature: Twin curved blades — river-knives or scimitars — swept in sweeping dual arcs.
Element cue (subtle, behind or around the figure only): Two crossing crimson arcs like converging rivers, a spiraling flurry of cut-lines, motion trails everywhere.
Element color (rim light + background gradient): Slash — core #C0313A, accent #F06A72.
```

*Full character brief: `../characters/20-slash-reyna.md`.*
