# Boldrek — "The Avalanche" — DALL·E Portrait Prompt (Crush)
...
Character: Boldrek, A mountainous bruiser who arrives all at once, like bad news; unstoppable momentum.
Build & silhouette: Enormous and top-heavy, boulder-shouldered — a rockslide with fists.
Face & demeanor: Broad and blunt, grinning with brute-glee beneath a heavy brow; flat nose, chipped teeth, wild hair.
Wardrobe: Bronze-plated slab armor with boulder-like pauldrons, chained rubble and scree hung on him; scarred and dented.
Held / signature: A massive maul or boulder-hammer, or simply huge gauntleted fists — he brings the mountain down.
Element cue (subtle, behind or around the figure only): A wave of tumbling rubble and a dust-cloud rolls ahead of him, bronze impact-rings shudder out, ground cracks apart.
Element color (rim light + background gradient): Crush — core #B5732E, accent #E0A15A.
```

*Full character brief: `../characters/25-crush-boldrek.md`.*
